"""
Filename: unittest_mpmath_eigen_markov.py
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Unittest for mpmath_eigen_markov.')
    parser.add_argument(
    ...
    v = mp.mp.stoch_eig(P)  # Stochastic eigenvector of P
